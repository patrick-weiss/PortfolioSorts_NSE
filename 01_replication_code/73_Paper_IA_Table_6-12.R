...
## Main table
table_main |>
  print_tex_table_nodes(file = "Paper_Tables/IA07_NSE_nodes_CAPM.tex")

## Internet appendix table
table_IA |>
  print_tex_table_nodes(file = "Paper_Tables/IA08_NSE_nodes_CAPM.tex")
...
## Main table
table_main |>
  print_tex_table_nodes(file = "Paper_Tables/IA09_NSE_nodes_FF5.tex")

## Internet appendix table
table_IA |>
  print_tex_table_nodes(file = "Paper_Tables/IA10_NSE_nodes_FF5.tex")
...
## Main table
table_main |>
  print_tex_table_nodes(file = "Paper_Tables/IA11_NSE_nodes_Q5.tex")
