...
# Boxplots ----------------------------------------------------------------
# Specifciations
figure_specs <- tibble(spec = c("alpha_FF5", "alpha_Q5",
                                "t_CAPM", "t_FF5", "t_Q5",
                                "se", "se_CAPM", "se_FF5", "se_Q5"),
                       label = c("Premium (in \\%)", "Premium (in \\%)",
                                 "$t$-statistic", "$t$-statistic", "$t$-statistic",
                                 "Standard errors", "Standard errors", "Standard errors", "Standard errors"))
